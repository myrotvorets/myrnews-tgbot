FROM myrotvorets/node-build@sha256:b413090fd60165f8e629bcc3c9b29337a8e021142a1614c8e86ab81bc9475e6a AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:e3ebb47b9c47930c026b47372243829490559ce356c4c0a184921cfc90881377
USER root
WORKDIR /srv/service
RUN chown nobody:nobody /srv/service
USER nobody:nobody
